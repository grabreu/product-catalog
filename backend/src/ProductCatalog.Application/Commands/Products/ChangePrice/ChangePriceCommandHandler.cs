...
public sealed class ChangePriceCommandHandler(IProductRepository repository, IUnitOfWork unitOfWork) : ICommandHandler<ChangePriceCommand, ErrorOr<ProductDto>>
{
    public async ValueTask<ErrorOr<ProductDto>> Handle(ChangePriceCommand command, CancellationToken cancellationToken)
    {
